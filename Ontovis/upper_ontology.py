...
class UpperOntology(object):
    ...
    def getOccurrences(self, property, stripns=True, ns=None, limit = 100):
        ...
        :param entityName: name or URI of a property in the ontology
        ...
        :return list<(string, string, string)>: a list of triples
        """
        if not ns:
        ...
        triples = []
        n = 0
        for s, p, o in self.graph.triples((None, propertyURI, object)):
            n += 1
            if n > limit:
                break
            if stripns:
