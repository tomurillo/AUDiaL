...
FILTER_COMP_LABELS = [JJR_TREE_POS_TAG, RBR_TREE_POS_TAG, JJ_TREE_POS_TAG]

FILTER_SUP_LABELS = [JJS_TREE_POS_TAG, RBS_TREE_POS_TAG]

FILTER_OPERAND_LABELS = [CD_TREE_POS_TAG]

FILTER_GT_TOKENS = ['higher', 'greater', 'bigger', 'larger', 'over', 'exceeding']
...
TASK_IGNORE = ["go", "proceed", "move", "show", "give", "tell", "say", "output", "compute", "set", "apply", "get"
               "fetch", "filter", "calculate", "infer", "is", "are", "was", "were"]
